...
Généré automatiquement le **25/03/2026 à 02:35:19**
...
@layer base {
  body { @apply bg-dark text-white font-sans antialiased; }
  ::-webkit-scrollbar { width: 4px; }
  ::-webkit-scrollbar-track { @apply bg-dark; }
  ::-webkit-scrollbar-thumb { @apply bg-dark-border rounded-full; }
}

@layer components {
  .btn { @apply px-4 py-2 rounded-lg font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed; }
  .btn-primary { @apply btn bg-primary text-white hover:bg-primary-dark active:scale-95; }
  .btn-ghost { @apply btn bg-transparent hover:bg-dark-card text-gray-300 hover:text-white; }
  .btn-danger { @apply btn bg-danger/10 text-danger border border-danger/30 hover:bg-danger/20; }
  .input { @apply w-full bg-dark-card border border-dark-border rounded-lg px-4 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:border-primary transition-colors text-sm; }
  .card { @apply bg-dark-card border border-dark-border rounded-xl p-4; }
...
export default {
  ...
  theme: {
    extend: {
      colors: {
        primary: { DEFAULT: '#1B7F79', light: '#2EBFB3', dark: '#0D5C58' },
        accent: '#F4A261',
        danger: '#E63946',
        success: '#2DC653',
        dark: { DEFAULT: '#0D1B2A', card: '#1A2235', border: '#243048' },
      },
...
---
*README généré automatiquement par [generate_readme.py](generate_readme.py) le 25/03/2026 à 02:35:19*
